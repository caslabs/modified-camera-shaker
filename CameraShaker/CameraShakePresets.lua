...
local CameraShakePresets = {
	...
	Sprinting = function()
		local c = CameraShakeInstance.new(1.5, 1.75, 0, 0)
		c.PositionInfluence = Vector3.new(0.5, 0.1, 0.1)
		c.RotationInfluence = Vector3.new(1, 0.75, 0.75)
		return c
	end;

	Walking = function()
		local c = CameraShakeInstance.new(0.5, 0.3, 0, 0)
		c.PositionInfluence = Vector3.new(0.1, 0.05, 0.05)
		c.RotationInfluence = Vector3.new(0.5, 0.25, 0.25)
		return c
	end;
